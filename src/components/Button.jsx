...
const Button = ({
    ...
    return (
        ...
        overflow-hidden border-[1.5px] border-white rounded-2xl px-6 pr-11 py-2 text-white
      ...
      `}
        >
            ...
            <span
                className="
          absolute inset-0 bg-white rounded-2xl -z-10 w-0 group-hover:w-full
        ...
        {children}
            ...
            {/* Right Icon */}
            {rightIcon && (
                <span className="relative z-10 ml-2 flex items-center">{rightIcon}</span>
            )}
        </button>
    );
};
