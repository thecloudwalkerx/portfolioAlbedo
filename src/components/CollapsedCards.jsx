...
const LI_CLASSES =
  "relative flex flex-row justify-start items-center rounded-xl cursor-pointer group overflow-hidden";
        ...
        <AnimatePresence key={item.title}>
          {!burstingCard || burstingCard !== item.title ? (
            ...
            >
              ...
              <motion.div
                className="absolute inset-0 rounded-xl backdrop-blur-lg"
                style={{
                  background:
              ...
              <div className="flex-1 ml-2 sm:ml-3 md:ml-4 relative z-10">
