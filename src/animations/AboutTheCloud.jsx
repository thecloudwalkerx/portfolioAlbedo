  ...
  return (
    <div ref={ref} className="relative w-full h-full flex order-1 lg:order-2">
      ...
      <motion.img
        ...
        alt="Background"
        className="relative left-20 md:left-10 w-75 sm:w-52 md:w-95 lg:w-110 z-10"
      ...
      <motion.div
        className="absolute top-25 md:top-0 md:left-20 left-8 sm:top-28 sm:left-60 z-20 pointer-events-none"
